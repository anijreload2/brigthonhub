...
const CATEGORY_CONFIG: Record<string, CategoryConfig> = {
  ...
  marketplace: {
    ...
    fields: {
      ...
      warranty_info: { label: 'Warranty Information', type: 'textarea' } as TextFieldConfig,
...
export default function CreateListing() {
  ...
  useEffect(() => {
    if (!user) {
      router.push('/auth/login?redirect=/vendor/listings/create');
      return;
    }
  ...
  const fetchApprovedCategories = async () => {
    ...
    try {
      ...
      const categories = applications?.flatMap(app => app.categories) || [];
      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <Card className="w-full max-w-md">
          <CardHeader className="text-center">
            ...
            <CardTitle>No Approved Categories</CardTitle>
            <CardDescription>
              You need to have at least one approved vendor category to create listings.
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <Button onClick={() => router.push('/vendor/register')} className="w-full">
              Apply for Vendor Status
            </Button>
            <Button variant="outline" onClick={() => router.push('/vendor/dashboard')} className="w-full">
              Back to Dashboard
            </Button>
          </CardContent>
        </Card>
  ...
  const categoryConfig = selectedCategory ? CATEGORY_CONFIG[selectedCategory as keyof typeof CATEGORY_CONFIG] : null;
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="flex items-center space-x-4 mb-8">
          ...
          <div>
            ...
            <p className="text-gray-600">Add a new listing to showcase your products or services</p>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Select the category for your listing</CardDescription>
            </CardHeader>
            <CardContent>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Add photos to showcase your listing</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
