...
INSERT INTO blog_categories (id, name, description, createdAt, updatedAt) VALUES
('cat-1', 'Real Estate', 'Property market insights and trends', NOW(), NOW()),
('cat-2', 'Agriculture', 'Modern farming and agricultural innovation', NOW(), NOW()),
('cat-3', 'Technology', 'Tech trends and digital innovation', NOW(), NOW()),
('cat-4', 'Business', 'Business development and entrepreneurship', NOW(), NOW())
ON CONFLICT (id) DO NOTHING;

-- Insert sample blog posts
INSERT INTO blog_posts (id, title, slug, content, excerpt, featuredImage, author, categoryId, tags, readingTime, views, likes, isPublished, isActive, publishedAt, createdAt, updatedAt) VALUES
...
'BrightonHub Team', 'cat-1', 
ARRAY['lagos', 'real-estate', 'investment', 'nigeria'], 5, 120, 15, true, true, NOW(), NOW(), NOW()),
...
'Agricultural Expert', 'cat-2',
ARRAY['agriculture', 'technology', 'farming', 'nigeria'], 6, 85, 8, true, true, NOW(), NOW(), NOW()),
...
'Tech Analyst', 'cat-3',
ARRAY['technology', 'startups', 'fintech', 'innovation'], 4, 95, 12, true, true, NOW(), NOW(), NOW()),
...
'Business Consultant', 'cat-4',
ARRAY['business', 'entrepreneurship', 'growth', 'sme'], 7, 78, 10, true, true, NOW(), NOW(), NOW())
